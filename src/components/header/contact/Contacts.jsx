...
const Contacts = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_r07nu77', 'template_fay6lb9', form.current, {
        publicKey: 'wzgltLPXWFDrHvl3N',
      })
      e.target.reset()
  };
  return (
    <section className="contact section" id="contact">
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">11-123-123</span>
              <a href="" className="contact_button">
                Write Your Message{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
      ...
      <div className="contact_container container grid">
        <div className="contact_content">
          <h3 className="contact_title">Subject</h3>
          <form ref={form} onSubmit={sendEmail} className="contact_form">
            ...
            <div className="contact_form-div">
              <label className="contact_form-tag">Subject</label>
              <textarea
                name="Subject"
                cols="30"
                rows="10"
